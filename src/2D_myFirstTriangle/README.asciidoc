...
* Each activity has example solutions in git branches
  ** you should look at these *after* attempting a solution yourself
...
. Make the background colour different
  ...
  .. Black
  .. Yellow
  .. **Example Branch** - for example solutions - `2D_backgroundColor`
...
. Make the triangle a different colour
  ...
  .. Purple
  .. Orange
  .. **Example Branch** - for example solutions - `2D_triangleColor`
...
. Make the triangle change colour on a keypress
  .. *Questions*
    ...
    .. **Example Branch** - for example solutions - `input_keyPress`
...
. Add details to the console text
  ...
  .. **Example Branch** - for example solutions - `output_consoleText`
...
. Make the triangle colour change over time
  ...
  .. **Example Branch** - for example solutions - `time_2D_triangleColor`
...
. Make the triangle have different colours for each of its points
  ...
  .. **Example Branch** - for example solutions - `2D_triangleColorPerVertex`
