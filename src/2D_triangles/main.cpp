...
GLfloat translationVector1[] = { -0.5f, -0.5f };
GLfloat translationVelocityVector1[] = { 0.1f, 0.1f};

GLfloat translationVector2[] = { 0.8f, -0.5f };
GLfloat translationVelocityVector2[] = { -0.2f, 0.15f};
...
void updateSimulation(double simLength = 0.02) //update simulation with an amount of time to simulate for (in seconds)
{
	...
	translationVector1[0] += (float)simLength * translationVelocityVector1[0];
	translationVector1[1] += (float)simLength * translationVelocityVector1[1];

	translationVector2[0] += (float)simLength * translationVelocityVector2[0];
	translationVector2[1] += (float)simLength * translationVelocityVector2[1];
}
...
void render()
{
	...
	//set translationVector and draw for triangle 1
	glUniform2f(translationVectorLocation, translationVector1[0], translationVector1[1]);
	glDrawArrays(GL_TRIANGLES, 0, 3);

	//set translationVector and draw for triangle 2
	glUniform2f(translationVectorLocation, translationVector2[0], translationVector2[1]);
	glDrawArrays(GL_TRIANGLES, 0, 3);
